  ...
  return (
    <div className='m-20'>
      <div className='mb-10 text-center'>
        <p className='font-bold text-2xl ml-5'>Welcome to Meda – Your Ultimate Shopping Destination!</p>
      </div>

      <div>
        <h1 className='font-bold text-2xl'>About Meda</h1>
        <p className='ml-5 mt-2'>At Meda, we believe in providing a seamless and enjoyable online shopping experience.Meda is dedicated to curating a diverse range of high-quality products and bringing them to your fingertips. Whether you're a fashion enthusiast, a tech guru, or someone looking for unique finds, we've got you covered.</p>
      </div>

      <div className='mt-8'>
        <h1 className='font-bold text-2xl'>Technology Stack</h1>
        <p className='ml-5 mt-2'>Meda is not just an ordinary Meda platform; it's a blend of cutting-edge technology and user-centric design. Our website is crafted using ReactJS for a smooth and responsive interface, TailwindCSS for a visually appealing layout, and Redux-toolkit to ensure efficient state management. We've leveraged the power of these technologies to create a platform that's not only visually stunning but also functionally robust.</p>
      </div>

      <div className='mt-8'>
        <h1 className='font-bold text-2xl'>What Sets Meda Apart</h1>
        <ol className='ml-2'>
          ...
          <li className='mt-2 mb-2'>
            ...
            <p className='ml-5 mt-1'> Meda boasts a diverse collection of products, spanning various categories to cater to your unique needs and preferences. From the latest fashion trends to cutting-edge gadgets, we have it all.</p>
          </li>
